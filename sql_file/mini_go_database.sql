...
CREATE TABLE passengers (
  ...
  latest_driver_rating TINYINT NOT NULL DEFAULT 0 CHECK(latest_driver_rating BETWEEN 0 AND 5),
  FOREIGN KEY (current_location) REFERENCES locations(id) ON UPDATE CASCADE ON DELETE SET NULL
);
...
CREATE TABLE drivers (
  ...
  latest_passenger_rating TINYINT NOT NULL DEFAULT 0 CHECK(latest_passenger_rating BETWEEN 0 AND 5),
  FOREIGN KEY (current_location) REFERENCES locations(id) ON UPDATE CASCADE ON DELETE SET NULL
);
...
-- ======================================================
-- TABLE: Ride History ( + Payment Info inside it)
-- ======================================================
CREATE TABLE ride_history (
  ...
  -- PAYMENT DETAILS HERE (INSTEAD OF SEPARATE TABLE)
